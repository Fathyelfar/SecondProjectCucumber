...
public class POM007_filterByColorPages {
    ...
    public WebElement filterbyColor1() {
        return Hooks.driver.findElement(By.xpath("/html/body/div[1]/div/header/div[2]/div/ul/div/div[1]/div[2]/li/a/span"));

    }

    public WebElement filterByColor2() {
        return Hooks.driver.findElement(By.xpath("/html/body/div[1]/div/header/div[2]/div[2]/div/div[2]/ul/li[1]/a/img"));

    }
    public WebElement filterByColor3() {
        return Hooks.driver.findElement(By.xpath("//*[@id=\"__next\"]/div/section/div/div/div/div[2]/div[2]/div/div[2]/button[2]/div/span[2]/img"));

    }
    public WebElement filterByColor4() {
        return Hooks.driver.findElement(By.xpath("//*[@id=\"__next\"]/div/section/div/div/div/div[2]/div[2]/div/div[1]/div/div[2]/div/div/label[3]/span/span/img"));
